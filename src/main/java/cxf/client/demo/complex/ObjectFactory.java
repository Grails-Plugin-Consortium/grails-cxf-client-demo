...
public class ObjectFactory {
    ...
    private final static QName _ComplexContrivedException_QNAME = new QName("http://foo.bar.com/", "ComplexContrivedException");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://foo.bar.com/", name = "ComplexContrivedException")
